...
/*
Fixed point arithmetic defines
*/


#define QBIT 14
#define convert_to_fixedpoint(x)  x<<QBIT
#define convert_to_int(x)   x>>QBIT
#define convert_to_nearest(x)  x > 0 ? convert_to_int((x+1<<(QBIT-1))) : convert_to_int((x-1<<(QBIT-1)))   
